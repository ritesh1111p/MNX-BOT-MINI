...
module.exports = {
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || '+917980046966', // Mettez votre numéro ici
    BOT_NAME: "MNX-MD Mini",
    BOT_FOOTER: '© ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝚳𝚯𝚯𝚴-𝚾 𝚾𝐃',
    ...
    // 7. IMAGES & LIENS
    // ===========================================================
    IMAGE_PATH: 'https://files.catbox.moe/eux4xg.jpg',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029VarfjW04tRrmwfb8x306',
    
    // ===========================================================
    // 8. EXTERNAL API (Optionnel)
    // ===========================================================
    TELEGRAM_BOT_TOKEN: process.env.TELEGRAM_BOT_TOKEN || '8707292149:AAGKDboh9hNkQxY8XyUB25aNN58k9WYTEOM',
    TELEGRAM_CHAT_ID: process.env.  TELEGRAM_CHAT_ID || '5924662015'
